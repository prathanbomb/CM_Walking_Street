...
import com.test.material.supitsara.materialnavigationtest.User;
...
public class UserDao extends AbstractDao<User, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Search = new Property(3, String.class, "search", false, "SEARCH");
    };
    ...
    public User readEntity(Cursor cursor, int offset) {
        User entity = new User( //
            ...
            cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3) // search
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, User entity, int offset) {
        ...
        entity.setSearch(cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3));
     }
